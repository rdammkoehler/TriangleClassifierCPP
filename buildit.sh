...
g++ $(gtest-config --cppflags --cxxflags) -o FloatMath.o -c FloatMath.cpp 
...
g++ $(gtest-config --ldflags --libs) -o TestTriangleClassifier TestTriangleClassifier.o Classifier.o Validator.o FloatMath.o
